    ...
    public void startTime()
    {
        ...
        countDownTimer=new CountDownTimer(totaltime + 1000,1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                String time=String.format("%02d:%02d min", TimeUnit.MILLISECONDS.toMinutes(millisUntilFinished),TimeUnit.MILLISECONDS.toSeconds(millisUntilFinished)-TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(millisUntilFinished)));
